...
public class PzshAdapter extends RecyclerView.Adapter<PzshAdapter.ViewHolder> {
    ...
    private List<Commodity.ResultBean.PzshBean.CommodityListBeanX> list;

    public PzshAdapter(Context context, List<Commodity.ResultBean.PzshBean.CommodityListBeanX> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.pzsh_layout, null);
